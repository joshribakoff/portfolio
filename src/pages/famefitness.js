...
export default () => (
  <div>
    ...
    <a href="{famefitBilling}" target="_blank"><Img src={famefitBilling} /></a>
    <a href="{famefitCal}" target="_blank"><Img src={famefitCal} /></a>
    <a href="{famefitMeasure}" target="_blank"><Img src={famefitMeasure} /></a>
    <a href="{famefitNewWeek}" target="_blank"><Img src={famefitNewWeek} /></a>
    <a href="{famefitOverageNotification}" target="_blank"><Img src={famefitOverageNotification} /></a>
    <a href="{famefitPlan}" target="_blank"><Img src={famefitPlan} /></a>
    <a href="{famefitServices}" target="_blank"><Img src={famefitServices} /></a>
    <a href="{famefitServicesUsed}" target="_blank"><Img src={famefitServicesUsed} /></a>
    <a href="{famefitUserdash}" target="_blank"><Img src={famefitUserdash} /></a>
    <a href="{planActivate}" target="_blank"><Img src={planActivate} /></a>
    <a href="{therapistAll}" target="_blank"><Img src={therapistAll} /></a>
    <a href="{therapistBooking1}" target="_blank"><Img src={therapistBooking1} /></a>
    <a href="{therapistBooking2}" target="_blank"><Img src={therapistBooking2} /></a>
    <a href="{therapistBooking3}" target="_blank"><Img src={therapistBooking3} /></a>
    <a href="{therapistFiltered}" target="_blank"><Img src={therapistFiltered} /></a>
